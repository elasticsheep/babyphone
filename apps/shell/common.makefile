...
#------------------------------------------------------------------------------
# sd-reader library
SD_READER_PATH = vendor/sd-reader_source_20090330-teensy
SD_READER_OPTS =
SD_READER_SRC = \
      $(SD_READER_PATH)/byteordering.c \
      $(SD_READER_PATH)/fat.c          \
      $(SD_READER_PATH)/partition.c    \
      $(SD_READER_PATH)/sd_raw.c
...
AUDIO_SRC = \
      ...
      $(AUDIO_PATH)/buffer.c      \
      $(AUDIO_PATH)/dac.c         \
      $(AUDIO_PATH)/interrupts.c  \
      $(AUDIO_PATH)/player.c      \
      $(AUDIO_PATH)/recorder.c    \
      $(AUDIO_PATH)/wavparser.c
...
EXTRAINCDIRS = \
    $(ROOT_PATH)/$(AUDIO_PATH)/      \
    $(ROOT_PATH)/$(LUFA_PATH)/       \
    $(ROOT_PATH)/$(SD_READER_PATH)/  \
    $(ROOT_PATH)/utils
...
CFLAGS += -Wa,-adhlns=$(patsubst $(ROOT_PATH)/%.c,$(OBJDIR)/%.lst,$<)
